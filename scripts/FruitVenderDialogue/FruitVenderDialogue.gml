...
function FruitVenderDialogue(){
	NewTextBox(RESOLUTION_H, "Hello old man, how do you do?", [-1], spr_orestes_portrait);
	NewTextBox(RESOLUTION_H, "Well, son, I’m still kicking, thank the Gods.", [-1], spr_fruit_vender_portrait);
	NewTextBox(RESOLUTION_H, "Are things in your life not going as they should be? ", [-1], spr_orestes_portrait);
	NewTextBox(RESOLUTION_H, "If you would be willing to enlighten a traveler such as myself, I would like to know what I can do to help.", [-1], spr_orestes_portrait);
	...
	NewTextBox(RESOLUTION_H, "That sounds so awful! Does the late king not have a son that can restore peace to Argos? ", [-1], spr_orestes_portrait);
	...
	NewTextBox(RESOLUTION_H, "*\\1A miracle or a curse\\0* I will be praying to Father Zeus that they will, old man. ", [-1], spr_orestes_portrait);
	NewTextBox(RESOLUTION_H, "... ", [-1], spr_orestes_portrait);
	NewTextBox(RESOLUTION_H, "What a homely looking cap you have there. Unfortunately, I lost my cap as I was traveling here, but I don’t have any money to spend.", [-1], spr_orestes_portrait);
	NewTextBox(RESOLUTION_H, "Would you let me have it? ", [-1], spr_orestes_portrait);
	...
	NewTextBox(RESOLUTION_H, " ", ["6\\I will help you.", "7\\Sorry, but I can't help you."], spr_orestes_portrait);
